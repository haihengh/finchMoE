...
This page records FinchMoE measurements on an 8 GB M2 MacBook Air and a
...
Each table states its workload and decoding settings. FinchMoE uses the
...
| --- | ---: | ---: |
| 8 GB M2, FinchMoE | 5.10-6.30 tok/s | ~1.9-2.1 GB footprint |
| 24 GB M5 Pro, FinchMoE | 31-35 tok/s | ~2.1 GB footprint |
...
- FinchMoE recorded a 1.89-2.09 GiB physical footprint. MLX reported
...
The MLX process required the larger host and is not an 8 GB FinchMoE
deployment path.
