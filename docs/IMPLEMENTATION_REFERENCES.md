...
FinchMoE builds on work by other developers and researchers. These are
...
- Hugging Face Transformers provides executable decoder cross-checks for
  ...
  FinchMoE used them to verify normalization, K/V derivation, routing,
...
- [Hugging Face swift-transformers](https://github.com/huggingface/swift-transformers)
  is the direct tokenizer dependency. FinchMoE adds bounded streaming
