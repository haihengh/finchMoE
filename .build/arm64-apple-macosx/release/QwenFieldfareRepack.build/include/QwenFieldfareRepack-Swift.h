...
#ifndef QWENFIELDFAREREPACK_SWIFT_H
#define QWENFIELDFAREREPACK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="QwenFieldfareRepack",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Downloads model files from HuggingFace using a <code>URLSessionDownloadTask</code> with
/// a progress delegate, optional <code>HF_TOKEN</code> bearer auth, and size-based skipping
/// of files that are already present.
SWIFT_CLASS("_TtC19QwenFieldfareRepack12HFDownloader")
@interface HFDownloader : NSObject
...
@interface HFDownloader (SWIFT_EXTENSION(QwenFieldfareRepack)) <NSURLSessionDownloadDelegate>
