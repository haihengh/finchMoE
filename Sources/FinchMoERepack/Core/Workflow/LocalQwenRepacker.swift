...
/// snapshot from disk and writes the `.finchturbo` install (int4-affine weights,
...
public final class LocalQwenRepacker {
    ...
    private func runPrepared(paths: RemoteInstallPaths,
        ...
        try FinchTurboLayoutValidator.validate(path: layoutPath, layers: plan.layers)
    ...
    private func writeManifest(plan: QwenRepackPlan,
        ...
        let bits = FinchTurboJSON.QuantBitWidths(
