...
/// On-disk page alignment unit for `.finchturbo` files. Fixed at 16 KB regardless
/// of host page size — the format is the contract, not the kernel.
enum Layout {
    static let pageBytes = FinchTurboFormatV1.alignmentBytes
}
...
enum RepackPlanner {
    ...
    private static func planResidentFile(path: String,
        ...
        let rawIdx = UInt64(FinchTurboBinary.indexHeaderBytes
            + entryCount * FinchTurboBinary.indexEntryBytes
            + stringTable.count)
        ...
        for name in baseNames {
            ...
            if isQuantizedPacked {
                ...
                entries.append(ResidentEntry(
                    name: name, dtype: FinchTurboFormatV1.DType.u32.rawValue,
    ...
    private static func planLayerFile(path: String, layer: Int,
        ...
        for (role, name) in roles {
            ...
            let wSlice = PerExpertTensorSlice(
                role: role, component: "weights", dtype: FinchTurboFormatV1.DType.u32.rawValue,
            ...
            let sSlice = PerExpertTensorSlice(
                role: role, component: "scales", dtype: FinchTurboFormatV1.DType.bf16.rawValue,
            ...
            let bSlice = PerExpertTensorSlice(
                role: role, component: "biases", dtype: FinchTurboFormatV1.DType.bf16.rawValue,
