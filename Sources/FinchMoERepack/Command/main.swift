...
private let usage = """
Usage:
  FinchMoERepack --output <model.fqturbo> [--overwrite] [--resume]
  FinchMoERepack --input-snapshot <dir> --output <model.fqturbo> [--overwrite]
  FinchMoERepack --discard-partial --output <model.fqturbo>
  FinchMoERepack --verify-install --input-fqturbo <model.fqturbo>
  FinchMoERepack --help
