...
import FlashQwen
import FlashQwenDecodeProtocol
...
public final class DecodeServiceInferenceClient: AppModelLifecycleClient,
    ...
    private func launchIndependentService() throws
        ...
        let label = "com.flashqwen.decode.\(identifier)"
        let socketPath = "/private/tmp/flashqwen-decode-\(identifier).sock"
    ...
    private static func defaultServiceURL() -> URL {
        return Bundle.main.executableURL!
            ...
            .appendingPathComponent("FlashQwenDecodeService")
    }
}
