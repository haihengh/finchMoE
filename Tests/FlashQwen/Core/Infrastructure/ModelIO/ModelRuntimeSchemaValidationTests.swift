...
@Suite struct ModelRuntimeSchemaValidationTests {
    ...
    @Test func rejectsOverflowingDerivedDimensions() throws {
        ...
        let config = ArchConfig(
            ...
            modelFamily: toy.modelFamily,
            attnOutputGate: toy.attnOutputGate,
            linearNumKeyHeads: toy.linearNumKeyHeads,
            linearNumValueHeads: toy.linearNumValueHeads,
            linearKeyHeadDim: toy.linearKeyHeadDim,
            linearValueHeadDim: toy.linearValueHeadDim,
            linearConvKernelDim: toy.linearConvKernelDim)
        #expect(throws: ModelError.self) {
            try Model.validateRuntimeSchema(
                residentIndex: model.residentIndex,
                layout: model.packedExpertsLayout,
